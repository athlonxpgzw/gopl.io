...
func TestEval(t *testing.T) {
	tests := []struct {
		...
		{"-1 - x", Env{"x": 1}, "-2"},
        {"min[x]", Env{"x": 11}, "11"},
        {"min[32, 321, 4324,x]", Env{"x": 11}, "11"},
        {"min[321, x]", Env{"x": 11}, "11"},
        {"min[321, x, y]", Env{"x": 11, "y": 6}, "6"},
        {"min[321, x, pow(y, 2)]", Env{"x": 11, "y": 3}, "9"},
        {"min[321, x, pow(y, 2), 5 / 9 * (F - 32)]", Env{"x": 11, "y": 3, "F": 32}, "0"},
		//!+Eval
	}
	var prevExpr string
